      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-5 leading-tight">
            Your Trade History is
            <br />
            Your Credit Score.
          </h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Every fee you log builds a verifiable digital track record. vPasi
            translates your hard work into an alternative credit profile that
            unlocks real capital.
          </p>
        </div>
        ...
        <div className="text-center">
          <Button className="btn-cta">Become a Lending Partner →</Button>
        </div>
      </div>
    </section>
  );
